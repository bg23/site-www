...
<?code-excerpt "test/samples_test.dart (hello-world)"?>
{% prettify dart %}
void main() {
  print('Hello, World!');
}
...
<?code-excerpt "test/samples_test.dart (var)"?>
{% prettify dart %}
var name = 'Voyager I';
var year = 1977;
...
<?code-excerpt "test/samples_test.dart (control-flow)"?>
{% prettify dart %}
if (year >= 2001) {
  print('21st century');
} else if (year >= 1901) {
...
<?code-excerpt "test/samples_test.dart (functions)"?>
{% prettify dart %}
int fibonacci(int n) {
  if (n == 0 || n == 1) return n;
...
<?code-excerpt "test/samples_test.dart (fat arrow)"?>
{% prettify dart %}
...
<?code-excerpt "test/samples_test.dart (import)" replace="/'.*?' as \w+/'path\/to\/my_other_file.dart'/g"?>
{% prettify dart %}
...
<?code-excerpt "lib/samples/spacecraft.dart (class)"?>
{% prettify dart %}
class Spacecraft {
  String name;
  DateTime launchDate;
...
<?code-excerpt "test/samples_test.dart (use class)"?>
{% prettify dart %}
...
<?code-excerpt "lib/samples/spacecraft.dart (extends)"?>
{% prettify dart %}
...
<?code-excerpt "lib/samples/spacecraft.dart (mixin)"?>
{% prettify dart %}
class Piloted {
  int astronauts = 1;
  void describeCrew() {
...
<?code-excerpt "lib/samples/spacecraft.dart (mixin use)" replace="/with/[!$&!]/g"?>
{% prettify dart %}
...
<?code-excerpt "lib/samples/spacecraft.dart (implements)"?>
{% prettify dart %}
...
<?code-excerpt "lib/samples/spacecraft.dart (abstract)" replace="/abstract/[!$&!]/g"?>
{% prettify dart %}
...
<?code-excerpt "lib/samples/spacecraft.dart (abstract use)" replace="/abstract/[!$&!]/g"?>
{% prettify dart %}
...
<?code-excerpt "test/samples_test.dart (async)" replace="/async/[!$&!]/g"?>
{% prettify dart %}
...
<?code-excerpt "test/samples_test.dart (Future.then)"?>
{% prettify dart %}
Future<Null> printWithDelay(String message) {
  return new Future.delayed(aSecond).then((_) {
    print(message);
  });
}
{% endprettify %}
...
<?code-excerpt "test/samples_test.dart (await)"?>
{% prettify dart %}
...
<?code-excerpt "test/samples_test.dart (async*)"?>
{% prettify dart %}
...
<?code-excerpt "test/samples_test.dart (throw)"?>
{% prettify dart %}
if (astronauts == 0) {
...
<?code-excerpt "test/samples_test.dart (try)"?>
{% prettify dart %}
try {
  for (var object in flybyObjects) {
...
<?code-excerpt "lib/samples/spacecraft.dart (get)" replace="/ShowingGetter//g"?>
{% prettify dart %}
class Spacecraft {
  // ···
  DateTime launchDate;
